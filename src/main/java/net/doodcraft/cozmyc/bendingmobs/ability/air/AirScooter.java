...
public class AirScooter {
    ...
    private boolean progress() {
        ...
        StaticMethods.playAirbendingParticles(entity.getLocation(), 5, (float) Math.random(), (float) Math.random(), (float) Math.random(), 0.0);
        StaticMethods.playAirbendingSounds(entity.getLocation());
        return true;
    }
